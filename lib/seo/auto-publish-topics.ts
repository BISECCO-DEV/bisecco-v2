...
export const BLOG_TOPICS: AutoPublishTopic[] = [
  { slug: "verifier-siren-artisan-2026", title: "Comment vérifier le SIREN d'un professionnel en 2026 : guide pratique", keywords: ["SIREN professionnel", "vérifier SIREN", "professionnel vérifié"] },
  ...
  { slug: "assurance-decennale-comprendre", title: "L'assurance décennale : ce que tout particulier doit savoir avant d'engager un professionnel", keywords: ["assurance décennale", "garantie travaux", "professionnel obligation"] },
  ...
  { slug: "label-rge-artisan-explications", title: "Label RGE : à quoi sert-il et comment vérifier qu'un professionnel l'a vraiment", keywords: ["RGE", "qualibat", "label professionnel"] },
  ...
  { slug: "boucher-charcutier-france-tradition", title: "Boucher de quartier : les vraies différences avec la grande distribution", keywords: ["boucher professionnel", "viande qualité", "circuit court"] },
  ...
  { slug: "boulanger-tradition-baguette-difference", title: "Baguette tradition vs baguette classique : ce qui change vraiment", keywords: ["boulanger professionnel", "baguette tradition", "pain qualité"] },
...
export const FIL_TOPICS: AutoPublishTopic[] = [
  ...
  { slug: "fil-pourquoi-vérifier-siren", title: "Pourquoi vérifier le SIREN d'un professionnel avant de signer un devis", keywords: ["SIREN", "professionnel vérifié"], kind: "conseil" },
  ...
  { slug: "fil-boulanger-vraie-baguette", title: "Boulanger professionnel : comment reconnaître une vraie baguette tradition", keywords: ["boulanger", "baguette tradition"], kind: "conseil", metierSlug: "boulanger" },
  ...
  { slug: "fil-bijoutier-bague-fiancailles", title: "Bague de fiançailles sur mesure : pourquoi passer par un bijoutier professionnel", keywords: ["bijoutier", "bague"], kind: "conseil" },
  ...
  { slug: "fil-comptable-artisan-besoin", title: "Professionnel : à quel moment de votre activité prendre un expert-comptable", keywords: ["expert-comptable", "professionnel"], kind: "conseil" },
  ...
  { slug: "fil-savoir-faire-bisecco-mission", title: "Pourquoi Bisecco vérifie chaque professionnel : notre engagement", keywords: ["Bisecco", "professionnel vérifié"], kind: "conseil" },
];
